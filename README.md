# Disco Editor  
  ...
  Go to the [Releases](https://github.com/stopthatnoise/disco-editor-releases/releases) page and download the latest `.exe` installer.
  ...
  **Supported platforms:** Windows
  ...
  See the full documentation in the [source repository](https://github.com/stopthatnoise/disco-bel-translation) (access required).
